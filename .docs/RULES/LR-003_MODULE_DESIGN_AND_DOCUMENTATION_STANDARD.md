...
5. 在接口功能列表中使用Excel表格格式：
   ...
   |------|----------|----------|----------|----------|----------|-------------------|----------|
   | 1 | 创建用户 | POST | `/service-user/user` | 创建新用户 | 用户管理 | 否 | [查看详情](#31-用户基础信息管理接口) |
   | 2 | 用户登录 | POST | `/service-user/auth/login` | 用户登录认证 | 认证管理 | 是 | [查看详情](#32-用户认证管理接口) |
   ```
